...
class AddMediaItemHandler : AbstractCollectionHandler(), PostRestHandler<SuccessStatus> {
    ...
    @OpenApi(
        ...
        requestBody = OpenApiRequestBody([OpenApiContent(ApiCreateMediaItemRequest::class)]),
        tags = ["Collection"],
        responses = [
    ...
    override fun doPost(ctx: Context): SuccessStatus {
        ...
        /* Parse media item request and perform sanity checks */
        val mediaItemRequest = try {
            ctx.bodyAsClass(ApiCreateMediaItemRequest::class.java)
        ...
        try {
            MediaCollectionManager.addMediaItem(mediaItemRequest)
